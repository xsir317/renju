...
return [
    ...
    'Nickname' => 'ニックネーム',
    'New User' => 'アカウントを作成',
    'Already have an account? Login here!' => 'すでにアカウントをお持ちですか? サインイン',
    'Don\'t have an account? Create your account!' => 'またアカウントがない？',
    'Your password is incorrect' => 'パスワードが正しくありません',
    //'You operate too fast,please try again later' => '您的操作太快，请稍后再试',
    'This email is already registered' => 'Ｅメールアドレスはすでに使用されています',
    ...
    ////rules 参考：http://renjusha.net/renju/ruleBook.html
    'Yamaguchi' => '題数打ち',
    'RIF' => '2題打ち',
    'Soosyrv8' => '四珠交替打ち',
    'Renju' => '連珠',
