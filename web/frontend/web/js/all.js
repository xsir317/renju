...
const _face_prefix = 'https://image.kk1.cn/icons/';
let pager = {
    /**
     *
...
// 服务端发来消息时
    ...
    this.actionEnter = function(_data)
    {
        ...
        {
            pager.show_msg("上海市第三届市民运动会五子棋总决赛<br />\n" +
                "主办单位：上海市第三届市民运动会组委会<br />\n" +
                "承办单位：上海市社会体育管理中心（上海市体育竞赛管理中心）、杨浦区体育局、上海宽棋企业管理咨询服务中心<br />\n" +
                "协办单位：上海市围棋协会<br />\n" +
                "支持单位：益海嘉里金龙鱼粮油食品股份有限公司");
        }
        //特殊提示end
    };
